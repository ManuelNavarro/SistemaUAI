...
class PuestoUnidad(models.Model):
	idPuestoUnidad = models.AutoField(primary_key = True)
...
class Plaza(models.Model):
	idPlaza = models.AutoField(primary_key = True)
...
class PlazaEmpleado(models.Model):
	idPlazaEmpleado = models.AutoField(primary_key = True)
...
class EstadoTransferencia(models.Model):
	idEstadoTransferencia = models.AutoField(primary_key = True)
...
class PrestamoExpediente(models.Model):
	idPrestamoExpediente = models.AutoField(primary_key = True)
...
class SerieExpediente(models.Model):
	idSerieExpediente = models.AutoField(primary_key = True)
...
class Estante(models.Model):
	idEstante = models.AutoField(primary_key = True)
...
class Bandeja(models.Model):
	idBandeja = models.AutoField(primary_key = True)
...
class EstadoExpediente(models.Model):
	idEstadoExpediente = models.AutoField(primary_key = True)
...
class ExpedienteCaja(models.Model):
	idExpedienteCaja = models.AutoField(primary_key = True)
	idExpediente = models.ForeignKey(Expediente, on_delete = models.DO_NOTHING)
